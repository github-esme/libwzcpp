...
const boost::container::vector<uint8_t> WZKey::kDefaultAESKey{
...
const boost::container::vector<uint8_t> WZKey::kZeroIV{0, 0, 0, 0};

const boost::container::vector<uint8_t> WZKey::kMSEAIV{0xB9, 0x7D, 0x63, 0xE9};

const boost::container::vector<uint8_t> WZKey::kGMSIV{0x4D, 0x23, 0xC7, 0x2B};
